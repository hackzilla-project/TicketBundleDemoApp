 ...
 */
final class Version20180601204730 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ticket_message DROP attachment_size, DROP attachment_mimetype');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ticket_message ADD attachment_size INT DEFAULT NULL, ADD attachment_mimetype VARCHAR(255) DEFAULT NULL COLLATE utf8_unicode_ci');
    }
}
